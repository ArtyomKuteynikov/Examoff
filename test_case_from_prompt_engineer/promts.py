...
```
Если значение “Минимальная сумма символов в Content” превышает 2000 символов, то тебе необходимо будет разделить текст на несколько частей, продолжив в последующем сообщении. Если возникает подобная ситуация, то ты должен следовать следующему формату:
...
GENERATOR_PROMPT = """
Перепроверь контекст и продолжай генерацию:
