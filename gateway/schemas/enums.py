...
class ReportChatStateEnum(StrEnum):
    ...
    ASK_ANALYSIS_TYPE. Выбор типа анализа. В каком типе отраслей проводить анализ: в экономическом плане,
    политическом и т.д.
    ...
    анти-монопольным законодательством, практическими примерами или вам нужен более углубленный анализ с собственными
    предложениями по изменению власти монополий?"
